...
Os nomes de Euler e [Bernoulli](https://pt.wikipedia.org/wiki/Daniel_Bernoulli) são muito associados entre si e ao conceito de *escoamento ideal* (VER REF SCHILICHTING), e de fato foi Euler quem formulou precisamente a Equação de Bernoulli (a partir de ideias deste) [@bib:white6]. O que chamamos de *Equação de Euler* em mecânica dos fluidos é uma forma diferencial da Equação de Bernoulli.
