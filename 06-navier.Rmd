...
O último passo para chegar às Equações de Navier-Stokes é considerar que o fluido tem viscosidade e densidades constantes, e obedece a uma linearidade entre a tensão viscosa e a taxa de deformação:

$$
\tau_{ij} = 2 \mu \varepsilon_{ij}
$$

onde o fator de 2 é apenas um conveniência matemática. 
